/**
 * Visibility.tsx — Visibility Handler Example
 *
...
import type { FormitivaPlugin, VisibilityHandler } from '@formitiva/react';
      ...
      <table style={{ borderCollapse: 'collapse', marginBottom: 20, fontSize: '0.82rem' }}>
        <thead>
          <tr>
            ...
            <th style={thStyle}>Admin Secret Key</th>
        ...
        <tbody>
          <tr>
            ...
            <td style={tdStyle}>visible</td>
            <td style={tdStyle}>enabled</td>
          </tr>
          <tr>
            <td style={tdStyle}><strong>editor</strong></td>
            <td style={tdStyle}>hidden</td>
            <td style={tdStyle}>enabled</td>
          </tr>
          <tr>
            <td style={tdStyle}><strong>viewer</strong></td>
            <td style={tdStyle}>hidden</td>
