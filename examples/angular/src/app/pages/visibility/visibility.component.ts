/**
 * visibility.component.ts — Visibility Handler Example
 *
...
import type { FormitivaPlugin, VisibilityHandler } from '@formitiva/angular';
  ...
  template: `
    <div class="page-content">
      ...
      <table class="info-table">
        <thead>
          <tr><th>Role</th><th>Admin Secret Key</th><th>Content</th></tr>
        </thead>
        <tbody>
